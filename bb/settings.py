...
SECRET_KEY = 'django-insecure-azy4^kxdpsj+ds&pcu--%5sbgef%vq-$7(93sbpl_&!tt(tw#n'
...
LOGIN_URL = 'login'  # The login URL for the @login_required decorator
...
RAZORPAY_KEY_ID ='rzp_test_LyDvHFBoVKKrhK'
RAZORPAY_SECRET_KEY ='R2hJFDBRLWtgyEKewolLizhX'